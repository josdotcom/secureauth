/*
 * SAS oauth2_authorization schema, adapted for PostgreSQL:
 *   blob      -> text        (SAS serializes tokens/metadata as strings)
 *   timestamp -> timestamptz (store true instants for accurate token expiry)
